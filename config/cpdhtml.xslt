...
<!-- $Id: cpdhtml.xslt,v 1.1 2007/05/07 14:05:05 robertof Exp $ -->
...
<body>
    ...
    Only those fragments longer than 3 lines of code are shown.
    <p/>
    <table border="1" class="summary" cellpadding="2">
      ...
      <tr>
        <td class="SummaryNumber"><xsl:value-of select="count(//duplication[@lines>3])"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>3]/@lines)"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>3]/@tokens)"/></td>
        <td class="SummaryNumber"><xsl:value-of select="sum(//duplication[@lines>3]/@tokens) * 4"/></td>
      </tr>
    </table>
    <p/>
    ...
    <xsl:for-each select="//duplication[@lines>3]">
